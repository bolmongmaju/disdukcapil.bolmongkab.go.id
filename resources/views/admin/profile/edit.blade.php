                ...
                <div class="card-body">
                    <form action="{{ route('admin.profile.update', $profile->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <textarea class="form-control content @error('maklumat') is-invalid @enderror" name="maklumat"
                                placeholder="Masukkan Dasar Maklumat Pelayanan" rows="10">{!! old('maklumat') ?? $profile->maklumat !!}</textarea>
                            @error('maklumat')
                            <div class="invalid-feedback" style="display: block">
                                {{ $message }}
                            </div>
