            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @can('faqs.index')
                        <li class="{{ setActive('admin/faq') }}"><a class="nav-link" href="{{ route('admin.faq.index') }}"><i class="fas fa-users"></i>
                        <span>Faq</span></a></li>
                        @endcan

                        @can('facilities.index')
                        <li class="{{ setActive('admin/facility') }}"><a class="nav-link"
                        href="{{ route('admin.facility.index') }}"><i class="fas fa-image"></i>
                        <span>Fasilitas</span></a></li>
                        @endcan

                        @can('pelayanans.index')
                        <li class="{{ setActive('admin/pelayanan') }}"><a class="nav-link"
                        href="{{ route('admin.pelayanan.index') }}"><i class="fas fa-image"></i>
