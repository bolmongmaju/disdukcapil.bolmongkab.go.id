...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //permission for faq
        Permission::create(['name' => 'faqs.index']);
        Permission::create(['name' => 'faqs.create']);
        Permission::create(['name' => 'faqs.edit']);
        Permission::create(['name' => 'faqs.delete']);

        //permission for facility
        Permission::create(['name' => 'facilities.index']);
        Permission::create(['name' => 'facilities.create']);
        Permission::create(['name' => 'facilities.edit']);
        Permission::create(['name' => 'facilities.delete']);
        ...
        //permission for pelayanan
        Permission::create(['name' => 'pelayanan.index']);
        Permission::create(['name' => 'pelayanan.create']);
        Permission::create(['name' => 'pelayanan.edit']);
        ...
        //permission for lapor
        Permission::create(['name' => 'lapors.index']);
        // Permission::create(['name' => 'profpegs.create']);
        // Permission::create(['name' => 'profpegs.edit']);
        Permission::create(['name' => 'lapors.delete']);

        //permission for survei
        Permission::create(['name' => 'surveis.index']);
        // Permission::create(['name' => 'profpegs.create']);
        // Permission::create(['name' => 'profpegs.edit']);
        Permission::create(['name' => 'surveis.delete']);
